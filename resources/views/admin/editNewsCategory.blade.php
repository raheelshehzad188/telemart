...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ URL::to('admin/listingNewsCategories')}}"><i class="fa fa-bars"></i> {{ trans('labels.Categories') }}</a></li>
                         ...
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updateNewsCategory', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="{{ URL::to('admin/listingNewsCategories')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                              </div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
