...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>{{ trans('labels.dashboard_Version') }} 2.2</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="{{ URL::to('admin/listingOrders')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="View All Orders">{{ trans('labels.viewAllOrders') }} <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
                ...
                <table class="table no-margin">
                  ...
                  @if(count($result['orders'])>0)
                      ...
                      <tr>
                        ...
                        <td>{{ $result['currency'][0]->currency_symbol }}{{ floatval($orders->total_price) }} </td>
                        <td>
            ...
            <div class="box-footer clearfix">
              ...
              <a href="{{ URL::to('admin/listingOrders') }}" class="btn btn-sm btn-default btn-flat pull-right" data-toggle="tooltip" data-placement="bottom" title="View All Orders">{{ trans('labels.viewAllOrders') }}</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
