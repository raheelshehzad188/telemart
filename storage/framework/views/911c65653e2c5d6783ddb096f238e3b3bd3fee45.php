                         ...
                         <div class="box-body">
                          ...
                          <?php endif; ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10 col-md-4">
                                <?php echo Form::text('ios_admob_id',  $result['setting'][0]->ios_admob_id, array('class'=>'form-control', 'id'=>'ios_admob_id')); ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10 col-md-4">
                                <?php echo Form::text('ios_ad_unit_id_banner',  $result['setting'][0]->ios_ad_unit_id_banner, array('class'=>'form-control', 'id'=>'ios_ad_unit_id_banner')); ?>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10 col-md-4">
                                <?php echo Form::text('ios_ad_unit_id_interstitial',  $result['setting'][0]->ios_ad_unit_id_interstitial, array('class'=>'form-control', 'id'=>'ios_ad_unit_id_interstitial')); ?>
                            ...
                            <div class="form-group">
                              ...
                              <select name="ios_admob" class="form-control">
                              	<option <?php if($result['setting'][0]->ios_admob == '1'): ?>
                                        selected
                                    <?php endif; ?>
                                 value="1"> <?php echo e(trans('labels.Show')); ?></option>
                              	<option <?php if($result['setting'][0]->ios_admob == '0'): ?>
                                        selected
                                    <?php endif; ?>
                                 value="0"> <?php echo e(trans('labels.Hide')); ?></option>
